...
cmd="deepspectrum $verbose_option features-with-parser $audio_base --parser $parser -o $output -en $extractionNetwork -fl $featureLayer -nm $melBands -fs $scale -cm $colourMap --no-labels"
echo $cmd
$cmd
